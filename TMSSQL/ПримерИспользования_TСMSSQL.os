...
ПараметрыПодключения.АдресСервера = "10.1.1.40";
ПараметрыПодключения.ИмяПользователя = "sa";
ПараметрыПодключения.ПарольПользователя = "pass";
ПараметрыПодключения.ИмяБазыДанных = "TestBase";
